...
import nikonov.torrentclient.metadata.domain.BencodeItem;
import nikonov.torrentclient.metadata.domain.metadata.*;
...
import static nikonov.torrentclient.metadata.domain.TorrentFileKey.*;
