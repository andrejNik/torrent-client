...
import static nikonov.torrentclient.client.network.domain.message.HandshakeMessage.HANDSHAKE_PSTR;
import static nikonov.torrentclient.client.network.domain.message.HandshakeMessage.HANDSHAKE_PSTRLEN;
